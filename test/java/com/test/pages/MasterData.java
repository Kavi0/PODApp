...
public class MasterData extends GenericWrappers {
	...
	public MasterData MasterDataPage() {
		...
		searchBox.click();
		  ...
		  explicitWait(shipID); shipID.sendKeys("21115177");
		  logger.info("Shipment ID: 21115177 is entered");
		  
		  WebElement mainSearchBtn = driver.findElement(By.id("mxui_widget_Button_1"));
		  ...
		  {
		  System.out.println("The shipment 21115177 is completed");
		  logger.info("Shipment ID: 21115177 is completed"); 
		  } else 
		  {
		  System.out.println("The shipment 21113553 is not completed yet");
		  logger.info("Shipment ID: 21115177 is not completed"); 
		  }

		  WebElement resetBtn = driver.findElement(By.id("mxui_widget_Button_1"));
	...
	public MasterData completedDateCalender() {
		...
		sleep(3000);
		WebElement homeButton = driver.findElement(By.xpath("//a[@role='button']"));
		homeButton.click();
	...
	/*
	 * @Test public MasterData createdDateCalender() {
	 * 
	 * sleep(1800); WebElement CreatedDatePicker = driver.findElement( By.
	 * xpath("//div[@id='mxui_widget_SearchInput_7']//button[@aria-label='Show date picker']"
	 * )); CreatedDatePicker.click(); sleep(1800); datePickerWidget();
	 * 
	 * driver.findElement(By.xpath("//a[@role='button']")).click(); return this; }
	 */
